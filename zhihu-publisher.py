...
def rename_image_ref(m, original=True):
    ...
    global root
    print("[debug50]", m.group(0), m.group(1), m.group(2), Path(image_folder_path.parent/m.group(1)).is_file() or (original and Path(image_folder_path.parent/m.group(2)).is_file()))
